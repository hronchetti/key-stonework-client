...
export default function Balustrading() {
  ...
  return (
    <ProductPage
      ...
      description="4 Balustrading products perfect for lining staircases, terraces and balconies. For bespoke design call us on 01604 592 949 or use the form on our contact page"
